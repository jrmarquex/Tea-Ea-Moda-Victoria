...
// Importações das imagens para a seção Hero
import heroImage1 from '/public/victoria-3 - ilustrada.webp';
import heroImage2 from '/public/by_vic_falcão00001_-_ilustrada.png';
